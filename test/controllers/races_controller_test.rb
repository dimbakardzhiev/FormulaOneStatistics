...
class RacesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create race" do
    assert_difference('Race.count') do
      post races_url, params: { race: { circuit_id: @race.circuit_id, date: @race.date, name: @race.name, round: @race.round, year: @race.year } }
    end
  ...
  test "should update race" do
    patch race_url(@race), params: { race: { circuit_id: @race.circuit_id, date: @race.date, name: @race.name, round: @race.round, year: @race.year } }
