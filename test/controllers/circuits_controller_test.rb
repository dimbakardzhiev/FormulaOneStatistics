...
class CircuitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create circuit" do
    assert_difference('Circuit.count') do
      post circuits_url, params: { circuit: { country: @circuit.country, location: @circuit.location, name: @circuit.name } }
    end
  ...
  test "should update circuit" do
    patch circuit_url(@circuit), params: { circuit: { country: @circuit.country, location: @circuit.location, name: @circuit.name } }
